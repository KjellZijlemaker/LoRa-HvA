...
void checkMessage(string sf_value){
    ...
    if(strcmp(value, "NEW_SF_6") == 0){
        sx1272.setSF(SF_6);
    }
    
    if(strcmp(value, "NEW_SF_7") == 0){
        sx1272.setSF(SF_7);
    }
    
    if(strcmp(value, "NEW_SF_8") == 0){
        sx1272.setSF(SF_8);
    }
    
    if(strcmp(value, "NEW_SF_9") == 0){
        sx1272.setSF(SF_9);
    }
    
    if(strcmp(value, "NEW_SF_10") == 0){
        sx1272.setSF(SF_10);
    }
    
    if(strcmp(value, "NEW_SF_11") == 0){
        sx1272.setSF(SF_11);
    }
    
    if(strcmp(value, "NEW_SF_12") == 0){
        sx1272.setSF(SF_12);
    }
}
...
void loop(void)
{
    ...
    if ( e == 0 ){
        ...
        if (message2.find("NEW") != string::npos){
            ...
            myfile.open("logRECSF.txt",std::ofstream::out | std::ofstream::app);
            myfile <<  str3;
